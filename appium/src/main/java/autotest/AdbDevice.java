...
import autotest.utils.MonkeyScriptUtils;
...
public class AdbDevice {
    ...
    public AdbDevice(String deviceID) {
        ...
        ShellUtils.cmd(this.deviceID, "wait-for-device");
    }
    ...
    public String getDeviceId() {
        Process ps = ShellUtils.shell(this.deviceID, "getprop ro.boot.serialno");
    ...
    public String getAndroidVersion() {
        Process ps = ShellUtils.shell(this.deviceID, "getprop ro.build.version.release");
    ...
    public int getSdkVersion() {
        Process ps = ShellUtils.shell(this.deviceID, "getprop ro.build.version.sdk");
    ...
    public int[] getScreenResolution() {
        ...
        Process ps = ShellUtils.shell(this.deviceID, "dumpsys display | grep PhysicalDisplayInfo");
    ...
    public int getBatteryLevel() {
        Process ps = ShellUtils.shell(this.deviceID, "dumpsys battery | grep level");
    ...
    public double getBatteryTemp() {
        Process ps = ShellUtils.shell(this.deviceID, "dumpsys battery | grep temperature");
        String out = ShellUtils.getShellOut(ps);
    ...
    public int getBatteryStatus() {
        Process ps = ShellUtils.shell(this.deviceID, "dumpsys battery | grep status");
        String out = ShellUtils.getShellOut(ps);
    ...
    public String getFocusedPackageAndActivity() {
        ...
        Process ps = ShellUtils.shell(this.deviceID, "dumpsys input | grep FocusedApplication");

        // Process ps = ShellUtils.shell(this.deviceID, "dumpsys window w | grep \\/ | grep
        // name=");
        ...
        if (component.isEmpty()) {
            return ReUtils
                    .matchString(pattern,
                            ShellUtils.getShellOut(ShellUtils.shell(this.deviceID, "dumpsys window w | grep \\/ | grep name=")))
                    .get(0);
        }
    ...
    public int getPid(String packageName) {
        Pattern pattern = Pattern.compile("([\" \"][0-9]+)");
        Process ps = ShellUtils.shell(this.deviceID, "ps | grep -w " + packageName);
    ...
    public boolean killProcess(int pid) {
        Process ps = ShellUtils.shell(this.deviceID, "kill " + pid);
        String out = ShellUtils.getShellOut(ps);
    ...
    public void quitCurrentApp() {
        ShellUtils.shell(this.deviceID, "am force-stop " + getCurrentPackageName());
    }
    ...
    public ArrayList<String> getSystemAppList() {
        ...
        Process ps = ShellUtils.shell(this.deviceID, "pm list packages -s");
    ...
    public ArrayList<String> getThirdAppList() {
        ...
        Process ps = ShellUtils.shell(this.deviceID, "pm list packages -3");
        StringBuilder sb = new StringBuilder();
        BufferedReader br = ShellUtils.shellOut(ps);
    ...
    public int getAppStartTotalTime(String component) {
        Process ps = ShellUtils.shell(this.deviceID, "am start -W " + component + " | grep TotalTime");
    ...
    public XuImage getSceenshot() {
        return XuImage.getXuImage(this.deviceID).screenShot();
    }
    ...
    public void pullFile(String remotePath, String localPath) {
        ShellUtils.getShellOut(ShellUtils.cmd(this.deviceID, "pull " + remotePath + " " + localPath));
    }
    ...
    public void pushFile(String localPath, String remotePath) {
        ShellUtils.getShellOut(ShellUtils.cmd(this.deviceID, "push " + localPath + " " + remotePath));
    }
    ...
    public void installApp(String appPath) {
        ShellUtils.getShellOut(ShellUtils.cmd(this.deviceID, "install " + appPath));
    }
    ...
    public void removeApp(String packageName) {
        ShellUtils.getShellOut(ShellUtils.cmd(this.deviceID, "uninstall " + packageName));
    }
    ...
    public boolean clearAppDate(String packageName) {
        Process ps = ShellUtils.shell(this.deviceID, "pm clear " + packageName);
     ...
     */
    public void reboot() {
        ShellUtils.cmd(this.deviceID, "reboot");
    }
    ...
    public void fastboot() {
        ShellUtils.cmd(this.deviceID, "reboot bootloader");
    }
    ...
    public String shell(String command) {
        return ShellUtils.getShellOut(ShellUtils.shell(this.deviceID, command));
    }
    ...
    public void startActivity(String component) {
        ShellUtils.shell(this.deviceID, "am start -n " + component);
    }
    ...
    public void startWebpage(String url) {
        ShellUtils.shell(this.deviceID, "am start -a android.intent.action.VIEW -d " + url);
    }
    ...
    public void callPhone(int number) {
        ShellUtils.shell(this.deviceID, "am start -a android.intent.action.CALL -d tel:" + number);
    }
    ...
    public void sendKeyEvent(int keycode) {
        ShellUtils.shell(this.deviceID, "input keyevent " + keycode);
        sleep(500);
    }
    ...
    public void longPressKey(int keycode) {
        ...
        String param = param1 + "\n" + param2 + "\n" + param3;
        MonkeyScriptUtils.writeScript(this.deviceID, param);
        runMonkey();
        sleep(500);
    }
    ...
    public void tap(int x, int y) {
        ShellUtils.shell(this.deviceID, "input tap " + x + " " + y);
        sleep(500);
    }
    ...
    public void tap(double x, double y) {
        ...
        ShellUtils.shell(this.deviceID, "input tap " + coords[0] + " " + coords[1]);
        sleep(500);
    }
    ...
    public void tap(Element e) {
        ShellUtils.shell(this.deviceID, "input tap " + e.getX() + " " + e.getY());
        sleep(500);
    }
    ...
    public void swipe(int startX, int startY, int endX, int endY, long ms) {
        ...
        MonkeyScriptUtils.writeScript(this.deviceID, "Drag(" + param + ")");
        runMonkey();

		/*
         * if (getSdkVersion() < 19) { ShellUtils.shell(this.deviceID, "input swipe " + startX
		 * + " " + startY + " " + endX + " " + endY); } else { ShellUtils.shell(this.deviceID, 
    ...
    public void swipe(double startX, double startY, double endX, double endY, long ms) {
        ...
        if (getSdkVersion() < 19) {
            ShellUtils.shell(this.deviceID, "input swipe " + coords[0] + " " + coords[1] + " " + coords[2] + " " + coords[3]);
        } else {
            ShellUtils
                    .shell(this.deviceID, "input swipe " + coords[0] + " " + coords[1] + " " + coords[2] + " " + coords[3] + " " + ms);
        }
    ...
    public void swipe(Element e1, Element e2, long ms) {
		...
		/*
		 * if (getSdkVersion() < 19) { ShellUtils.shell(this.deviceID, "input swipe " +
		 * e1.getX() + " " + e1.getY() + " " + e2.getX() + " " + e2.getY()); }
		 * else { ShellUtils.shell(this.deviceID, "input swipe " + e1.getX() + " " + e1.getY()
		 * + " " + e2.getX() + " " + e2.getY() + " " + ms); }
		 */
    ...
    public void pinchZoom(int startX1, int startY1, int endX1, int endY1, int startX2, int startY2, int endX2,
        ...
        String param = startX1 + "," + startY1 + "," + endX1 + "," + endY1 + "," + startX2 + "," + startY2 + "," + endX2
                + "," + endY2 + "," + ms;
        MonkeyScriptUtils.writeScript(this.deviceID, "PinchZoom(" + param + ")");
        runMonkey();
    }
    ...
    public void sendText(String text) {
        ...
        for (int i = 0; i < length; i++) {
            ShellUtils.shell(this.deviceID, "input text " + out.get(i));
            sleep(100);
            if (i != length - 1) {
    ...
    public void runMonkeyTest(int time, String packageName) {
        int count = time;
        String command = "monkey -p " + packageName + " --pct-touch 60 --pct-motion 35 --pct-syskeys 5 --throttle 1000 -v " + count;
